    ...
    <MarketingLayout>
          ...
          <div className="space-y-6">
            <div className="panel rounded-[2rem] p-6 md:p-8">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-[0.7fr_1.3fr]">
                <div className="rounded-[1.25rem] bg-surface-strong px-4 py-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">
                    Standard lead time
                  </p>
                ...
                <div className="rounded-[1.25rem] bg-surface-strong px-4 py-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">
                    Dummy certifications and sales tags
                  </p>
      ...
      <section className="section-shell pb-16">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <h2 className="mt-5 display-title text-4xl font-semibold text-foreground">
                  Variant-aware quoting starts here.
                </h2>
              </div>
              <Link
                href="/rfq"
                className="hidden rounded-full bg-accent px-5 py-3 text-sm font-semibold text-ink-inverse md:inline-flex"
              >
                RFQ this product
              </Link>
            </div>
          ...
          <div className="grid gap-6">
            <div className="panel rounded-[2rem] p-6 md:p-8">
              <span className="eyebrow">Quote Handling</span>
              <h2 className="mt-5 display-title text-3xl font-semibold text-foreground">
                Public detail, private pricing.
              </h2>
              <p className="mt-4 text-sm leading-7 text-muted">
                Customers see product structure and application context. Final numbers remain in the owner-side price book and quotation flow.
              </p>
              <Link
                href="/rfq"
                className="mt-6 inline-flex rounded-full bg-[#17232d] px-5 py-3 text-sm font-semibold text-ink-inverse"
              >
                Start RFQ
              </Link>
            </div>
